...
// EXILEFORGE_REPOE_IMPORTER_VERSION: 2_NO_STAT_TRANSLATIONS
...
const FILES = {
  ...
  tags: "tags.min.json",
  statTranslations: "stat_translations.min.json"
};
...
async function main() {
  ...
  writeJson(path.join(appRoot, "stat-translations.json"),
    downloaded.statTranslations.json
  );
